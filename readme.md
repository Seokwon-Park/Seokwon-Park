...
* **Tech:** C++, OpenGL, DX11, DX12, Vulkan
* **Description:** 다양한 그래픽스 API를 지원하는 자체 제작 3D 게임 엔진입니다.
* **Key Features:** * 멀티스레드 렌더링 파이프라인 구축
    * 크로스 플랫폼 호환성을 고려한 아키텍처 설계
<details>
<summary><b>스크린샷 보기</b></summary>
<br>
<img width="400" alt="image" src="https://github.com/user-attachments/assets/7fc2e770-eeee-4d7a-8c1e-4cb61463f0ea" />
</details>

## Puyo Puyo 2 clone
[뿌요뿌요 2 모작](https://github.com/Seokwon-Park/APIEngine)   
<img width="813" height="609" alt="image" src="https://github.com/user-attachments/assets/c2fcafb1-88e9-4b62-85c3-46086b2ec9eb" />
